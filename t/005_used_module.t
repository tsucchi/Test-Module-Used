...
my $used = Test::Module::Used->new(
    module_dir => ['t/testdata/lib'],
);
is_deeply([$used->_target_files], ['t/testdata/lib/SampleModule.pm']);
is_deeply([$used->_used_modules()], [qw(Net::FTP Module::Used Test::Module::Used)]);
is($used->_version_from_file(), '5.00803'); # perl version specified in t/testdatalib/SampleModule.pm
